...
/*   Updated: 2021/02/11 15:42:53 by ldes-cou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_type(t_data *data)
{
	...
	//data->fun_array[0] = &ft_convert_c;
	data->fun_array[1] = (f)&ft_convert_s;
	//data->fun_array[2] = &ft_convert_p;
	//data->fun_array[3] = &ft_convert_i;
	//data->fun_array[4] = &ft_convert_i;
	//data->fun_array[5] = &ft_convert_u;
	//data->fun_array[6] = &ft_convert_x_lo;
	//data->fun_array[7] = &ft_convert_x_up;
	//data->fun_array[8] = &ft_convert_%;
}
